...
void SleepBreathingRadar::Bodysign_judgment(byte inf[], float Move_min, float Move_max){
  typedef union
  {
...
unsigned short int SleepBreathingRadar::us_CalculateCrc16(unsigned char *lpuc_Frame, unsigned short int lus_Len){
